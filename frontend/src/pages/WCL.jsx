...
export default function WCL() {
  ...
  const extractCode = (input) => {
    // Support full URL like https://www.warcraftlogs.com/reports/XXXXX
  ...
  return (
    <div className="min-h-screen bg-base-300">
      ...
      <div className="bg-gradient-to-b from-base-100 to-base-300 py-8 px-4 text-center">
        <h1 className="text-4xl font-title-cn text-primary mb-2">📜 大秘境复盘</h1>
        <p className="text-base-content/60">粘贴 WarcraftLogs 链接或 Report Code，AI 帮你分析今晚谁是拖累</p>
      </div>
          ...
          <div className="card-body">
            <div className="flex gap-2">
              <input
                ...
                placeholder="粘贴 WCL 链接或 Report Code（如 a1b2c3d4）"
                value={code}
            ...
            <p className="text-xs text-base-content/40 mt-1">
              支持格式：https://www.warcraftlogs.com/reports/xxxxxx 或直接粘贴 Report Code
            </p>
          </div>
        </div>
      ...
      <footer className="text-center py-6 text-base-content/30 text-xs">
        <p>deyangstats · 数据由 <a href="https://www.warcraftlogs.com" target="_blank" rel="noopener noreferrer" className="link">WarcraftLogs</a> 提供</p>
      </footer>
    </div>
  );
}
